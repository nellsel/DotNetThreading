...
namespace ProgressBar
{
        internal class BusinessLayer
        {
            ...
            public static void ProcessData(int data, CancellationToken token, Action<string> updateUICallBack)
            {
            ...
            /// <param name="data"></param>
            /// <param name="updateUICallBack"></param>
            public static void PerformInternalValidationsOnData(object data, CancellationToken token, Action<string, bool> updateUICallBack)
            {
                Task.Factory.StartNew(
                    () =>
                    {
            ...
            /// <param name="data"></param>
            /// <param name="updateUICallBack"></param>
            public static void PrepareTransformationsForProcessing(object data, CancellationToken token,  Action<string, bool> updateUICallBack)
            {
                Task.Factory.StartNew(
                    () =>
                    {
            ...
            /// <param name="data"></param>
            /// <param name="updateUICallBack"></param>
            public static void PrepareLaunchSequenceForData(object data, CancellationToken token, Action<string, bool> updateUICallBack)
            {
